...
//	 ArrayList<EmpDTO> list =this.empMapper.selectEmp();
	...
	/*
	 * @PostMapping("/scott/emp/{deptno}") public ResponseEntity<List<EmpDTO>>
	 * selectEmp(@PathVariable("deptno") int deptno) {
	 * logger.info("> ScottContoller.selectEmp()"); ArrayList<EmpDTO> list =
	 * this.empMapper.selectEmpByDeptno(deptno);
	 * 
