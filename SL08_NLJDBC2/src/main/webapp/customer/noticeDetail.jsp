				...
				<div id="content">
					...
					<div id="notice-article-detail" class="article-detail margin-large" >						
						...
						<dl class="article-detail-row">
							...
							<dd class="article-detail-data">
								<!-- <a href="">flag.png</a> -->
								<a download="${ noticeVO.filesrc }" href="/customer/upload/${ noticeVO.filesrc }">${ noticeVO.filesrc }</a>
							</dd>
						</dl>
					...
					<p class="article-comment margin-small">
						...
						<a class="btn-edit button" href="noticeEdit.htm?seq=${ noticeVO.seq }">수정</a>
						<a class="btn-del button" href="noticeDel.htm?seq=${ noticeVO.seq }&filesrc=${ noticeVO.filesrc }">삭제</a>
					</p>
